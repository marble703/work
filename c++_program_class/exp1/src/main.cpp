        ...
        if (cin_shape == EXIT) {
            ...
            while (true) {
                ...
                if (cin_operate == EXIT) {
                    ...
                    std::cout << "已旋转线段，颜色:黄色，长度:"
                              << line_rotate.getLength_Line() << std::endl;
                    ...
                    std::cout << "已镜像线段，颜色:红色，长度:"
                              << line_mirror.getLength_Line() << std::endl;
                    ...
                    std::cout << "已缩放线段，颜色: 白色，长度:"
                              << line_scale.getLength_Line() << std::endl;
                    drawLine(line_scale, { 1.0f, 1.0f, 1.0f }); // 白色
                    glfwSwapBuffers(window);
                }
            }
        } else if (cin_shape == CIRCLE) {
            std::cout << "请输入三个实数代表圆心的坐标x,y以及半径" << std::endl;
            std::cin >> x_1 >> y_1 >> radius;
            Circle circle(Point(x_1, y_1), radius);
            std::cout << "已生成圆，颜色:蓝色，周长:" << circle.getCircle_perimeter()
                      << "，面积:" << circle.getCircle_area() << std::endl;
            ...
            while (true) {
                ...
                if (cin_operate == EXIT) {
                    ...
                    std::cout << "已平移圆，颜色:绿色，周长:"
                              << circle_translate.getCircle_perimeter()
                              << "，面积:" << circle_translate.getCircle_area()
                              << std::endl;
                    ...
                    std::cout << "已旋转圆，颜色:黄色，周长:"
                              << circle_rotate.getCircle_perimeter()
                              << "，面积:" << circle_rotate.getCircle_area() << std::endl;
                    drawCircle(circle_rotate, { 1.0f, 1.0f, 0.0f }); // 黄色
                    glfwSwapBuffers(window);
                } else if (cin_operate == MIRROR) {
                    std::cout << "请输入镜像中心的坐标x,y:" << std::endl;
                    std::cin >> center_x >> center_y;
                    Circle circle_mirror(circle);
                    circle_mirror.mirror_Circle(Point(center_x, center_y));
                    std::cout << "已镜像圆，颜色:红色，周长:"
                              << circle_mirror.getCircle_perimeter()
                              << "，面积:" << circle_mirror.getCircle_area() << std::endl;
                    drawCircle(circle_mirror, { 1.0f, 0.0f, 0.0f }); // 红色
                    glfwSwapBuffers(window);
                } else if (cin_operate == SCALE) {
                    std::cout << "请输入缩放倍数:" << std::endl;
                    std::cin >> factor;
                    Circle circle_scale(circle);
                    circle_scale.scale_Circle(factor);
                    std::cout << "已缩放圆，颜色:白色，周长:"
                              << circle_scale.getCircle_perimeter()
                              << "，面积:" << circle_scale.getCircle_area() << std::endl;
                    drawCircle(circle_scale, { 1.0f, 1.0f, 1.0f }); // 白色
                    glfwSwapBuffers(window);
                }
            }
        } else if (cin_shape == RECTANGLE) {
            ...
            std::cout << "已生成矩形，颜色:蓝色，周长:"
                      << rectangle.getRectangle_perimeter()
                      << "，面积:" << rectangle.getRectangle_area() << std::endl;
            ...
            while (true) {
                ...
                if (cin_operate == EXIT) {
                    ...
                    std::cout << "已平移矩形，颜色:绿色，周长:"
                              << rectangle_translate.getRectangle_perimeter()
                              << "，面积:" << rectangle_translate.getRectangle_area()
                              << std::endl;
                    ...
                    std::cout << "已旋转矩形，颜色:黄色，周长:"
                              << rectangle_rotate.getRectangle_perimeter()
                              << "，面积:" << rectangle_rotate.getRectangle_area()
                              << std::endl;
                    ...
                    std::cout << "已镜像矩形，颜色:红色，周长:"
                              << rectangle_mirror.getRectangle_perimeter()
                              << "，面积:" << rectangle_mirror.getRectangle_area()
                              << std::endl;
                    ...
                    std::cout << "已缩放矩形，颜色:白色，周长:"
                              << rectangle_scale.getRectangle_perimeter()
                              << "，面积:" << rectangle_scale.getRectangle_area()
                              << std::endl;
                    drawRectangle(rectangle_scale, { 1.0f, 1.0f, 1.0f }); // 白色
                    glfwSwapBuffers(window);
                }
            }
        } else if (cin_shape == TRIANGLE) {
            ...
            std::cout << "已生成三角形，颜色:蓝色，周长:"
                      << triangle.getTriangle_perimeter()
                      << "，面积:" << triangle.getTriangle_area() << std::endl;
            ...
            while (true) {
                ...
                if (cin_operate == EXIT) {
                    ...
                    std::cout << "已平移三角形，颜色:绿色，周长:"
                              << triangle_translate.getTriangle_perimeter()
                              << "，面积:" << triangle_translate.getTriangle_area()
                              << std::endl;
                    ...
                    std::cout << "已旋转三角形，颜色:黄色，周长:"
                              << triangle_rotate.getTriangle_perimeter()
                              << "，面积:" << triangle_rotate.getTriangle_area()
                              << std::endl;
                    ...
                    std::cout << "已镜像三角形，颜色:红色，周长:"
                              << triangle_mirror.getTriangle_perimeter()
                              << "，面积:" << triangle_mirror.getTriangle_area()
                              << std::endl;
                    ...
                    std::cout << "已缩放三角形，颜色:白色，周长:"
                              << triangle_scale.getTriangle_perimeter()
                              << "，面积:" << triangle_scale.getTriangle_area()
                              << std::endl;
